...
Alicia	J	Zelaya	999887777	1968-01-19	3321 Castle, Spring, TX	F	27500.00	987654321	4
...
--
-- Name: pname_unique; Type: CONSTRAINT; Schema: public; Owner: danilo; Tablespace: 
--
...
--
-- Name: dno_fkey; Type: FK CONSTRAINT; Schema: public; Owner: danilo
--

ALTER TABLE ONLY employee
    ADD CONSTRAINT dno_fkey FOREIGN KEY (dno) REFERENCES department(dnumber);


--
-- Name: dnum_fkey; Type: FK CONSTRAINT; Schema: public; Owner: danilo
--

ALTER TABLE ONLY project
    ADD CONSTRAINT dnum_fkey FOREIGN KEY (dnum) REFERENCES department(dnumber);


--
-- Name: dnumber_fkey; Type: FK CONSTRAINT; Schema: public; Owner: danilo
--

ALTER TABLE ONLY dept_locations
    ADD CONSTRAINT dnumber_fkey FOREIGN KEY (dnumber) REFERENCES department(dnumber);


--
-- Name: essn_fkey; Type: FK CONSTRAINT; Schema: public; Owner: danilo
--

ALTER TABLE ONLY works_on
    ADD CONSTRAINT essn_fkey FOREIGN KEY (essn) REFERENCES employee(ssn);
...
--
-- Name: mgr_ssn_fkey; Type: FK CONSTRAINT; Schema: public; Owner: danilo
--

ALTER TABLE ONLY department
    ADD CONSTRAINT mgr_ssn_fkey FOREIGN KEY (mgr_ssn) REFERENCES employee(ssn);


--
-- Name: pno_fkey; Type: FK CONSTRAINT; Schema: public; Owner: danilo
--

ALTER TABLE ONLY works_on
    ADD CONSTRAINT pno_fkey FOREIGN KEY (pno) REFERENCES project(pnumber);


--
-- Name: super_ssn_fkey; Type: FK CONSTRAINT; Schema: public; Owner: danilo
--

ALTER TABLE ONLY employee
    ADD CONSTRAINT super_ssn_fkey FOREIGN KEY (super_ssn) REFERENCES employee(ssn);
